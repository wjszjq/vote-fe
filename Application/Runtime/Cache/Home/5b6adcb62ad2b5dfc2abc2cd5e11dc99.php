...
<!-- ngView:  --><div ng-view="" class="route"><div class="container-full" ng-controller="mainCtrl" style="position: relative">
    ...
    <div class="login-panel">
        <div class=" form-width" style="height: 3px">
            <div id="loginBtn" class="rg-title left rg-title-selected" ng-class="{&#39;rg-title-selected&#39;:model.isLogin}" ng-click="change(true)"> 登录</div>
            <div id="regBtn" class="right rg-title cursor-pointer" ng-class="{&#39;rg-title-selected&#39;:!model.isLogin}" ng-click="change(false)">注册</div>
        ...
        <form class="ng-pristine ng-valid">
            <div style="margin-top: 30px" class="rg-form">
                <input type="text" class="rg-input ng-pristine ng-untouched ng-valid" ng-model="lgUser.username" ng-blur="checkSuperId(true)" placeholder="手机/邮箱">
                <div ng-show="!validUname" class="error-tag ng-hide"></div>
            </div>
            <div class="rg-form">
                <input type="password" class="rg-input ng-pristine ng-untouched ng-valid" ng-model="lgUser.password" placeholder="密码">
            ...
            <button type="button" ng-click="login()" class="rg-btn" ng-class="login_ing?&#39;rg-btn-click&#39;:&#39;&#39;" ng-bind="login_ing ? &#39;登录中...&#39;:&#39;登录&#39;">登录</button>
        </form>
